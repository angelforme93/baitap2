				...
				<table class="shop_table beta-shopping-cart-table" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-status">Price</th>
					...
					@foreach(Cart::Content() as $item)
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="image/product/{{$item->options['image']}}" alt="" width="100px" height="100px">
							...
							<td class="product-quantity">
								...
								<form method="post">
								<input onchange="updateCart(this.value,'{{$item->rowId}}')" type="number" name="soluong" value="{{$item->qty}}" style='    padding: 4px 1.3px;
    outline: none;'>
								</form>
							</td>
							...
							<td class="product-remove">
								<a onclick="deleteCart('{{$item->rowId}}')" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
					@endforeach	
					</tbody>
			...
			<div class="cart-collaterals">
				...
				<div class="cart-totals pull-right">
					...
					<div class="cart-totals-row"><span>Order Total:</span> <span>{{Cart::total()}}</span></div>
				</div>
